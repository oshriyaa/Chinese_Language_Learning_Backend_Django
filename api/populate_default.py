...
from customer.models import RatingLevel
from order. models import PaymentSystem, OrderStatus, OrderSource, OrderType
from promotions.models import PromotionType
from rewards.models import AcquisitionType
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        dummy_data_path = os.path.join(file_path, 'default_tables.xlsx')     # path of the excel with dummy data
